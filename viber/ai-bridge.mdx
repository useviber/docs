...
1. **Click the Viber widget** (🤖) in your browser
...
```
Your Browser → Viber Plugin → Viber CLI → Cursor CLI → Your Project
```
...
**AI Bridge enables local-only AI-powered development with Cursor CLI and other local AI tools.** No external servers, no complex setup - just powerful local AI coding assistance! 🚀
